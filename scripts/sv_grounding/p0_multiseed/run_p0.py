...
Jalankan:  uv run python scripts/sv_grounding/p0_multiseed/run_p0.py
"""
import subprocess
import sys
import os
...
STEPS = [
    ("FT multi-seed",        "scripts/sv_grounding/p0_multiseed/p0_ft_multiseed.py"),
    ("Champion multi-seed",  "scripts/sv_grounding/p0_multiseed/p0_champion_multiseed.py"),
    ("Aggregate + vonis",    "scripts/sv_grounding/p0_multiseed/p0_aggregate.py"),
]


def main():
    # run_p0.py ada di scripts/sv_grounding/p0_multiseed/ -> root = 4 level di atas (nested di sv_grounding/)
